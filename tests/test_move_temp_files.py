...
class TestMoveTempFiles:
    ...
    def test_move_temp_files(self, mock_get_github_user_repo_from_config, mock_safe_move, mock_path, mock_parse_args, tmpdir):
        # Mock the arguments
        mock_parse_args.return_value = MagicMock(target_directory=str(tmpdir), dry_run=False)
